...
sds <- get_subdatasets("AIRS.2020.03.01.L3.RetStd_IR031.v6.0.31.1.G20105141600.hdf")
View(sds)
gdal_translate(sds[150], dst_dataset = "1502020Mar.tif")
gdal_translate(sds[328], dst_dataset = "3282020Mar.tif")
rast <- raster("1502020Mar.tif", band=6)
rast1 <- raster("3282020Mar.tif", band=6)
