...
sds <- get_subdatasets("AIRS.2020.08.01.L3.RetStd_IR031.v6.0.31.1.G20261110756.hdf")
View(sds)
gdal_translate(sds[150], dst_dataset = "1502020Aug.tif")
gdal_translate(sds[328], dst_dataset = "3282020Aug.tif")
rast <- raster("1502020Aug.tif", band=6)
rast1 <- raster("3282020Aug.tif", band=6)
