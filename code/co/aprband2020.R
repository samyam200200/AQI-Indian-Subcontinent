...
sds <- get_subdatasets("AIRS.2020.04.01.L3.RetStd_IR030.v6.0.31.1.G20125102228.hdf")
View(sds)
gdal_translate(sds[150], dst_dataset = "1502020Apr.tif")
gdal_translate(sds[328], dst_dataset = "3282020Apr.tif")
rast <- raster("1502020Apr.tif", band=6)
