...
sds <- get_subdatasets("AIRS.2020.06.01.L3.RetStd_IR030.v6.0.31.1.G20195132654.hdf")
View(sds)
gdal_translate(sds[150], dst_dataset = "1502020Jun.tif")
gdal_translate(sds[328], dst_dataset = "3282020Jun.tif")
rast <- raster("1502020Jun.tif", band=6)
rast1 <- raster("3282020Jun.tif", band=6)
