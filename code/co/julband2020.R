...
sds <- get_subdatasets("AIRS.2020.07.01.L3.RetStd_IR031.v6.0.31.1.G20220012614.hdf")
View(sds)
gdal_translate(sds[150], dst_dataset = "1502020Jul.tif")
gdal_translate(sds[328], dst_dataset = "3282020Jul.tif")
rast <- raster("1502020Jul.tif", band=6)
rast1 <- raster("3282020Jul.tif", band=6)
