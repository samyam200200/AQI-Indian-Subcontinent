...
plt <- levelplot(mean2, margin=FALSE, at=my.at, cuts=100 ,par.settings=mapTheme, main="NO2 Index - June 2019 - Molecules/cm^2",shrink=c(1,1), interpolate=T)
