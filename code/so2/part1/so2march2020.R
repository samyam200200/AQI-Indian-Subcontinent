...
plt <- levelplot(subtract, margin=FALSE,cuts=100,at=my.at,par.settings=mapTheme,main="SO2 Index - Diffrence March(2020-2019)",shrink=c(1,1), interpolate=T, cex=2)
...
qnorm(.975)*(sd(dataapr2020, na.rm=TRUE)/sqrt(22400))
...
qnorm(.975)*(sd(dataapr2019, na.rm=TRUE)/sqrt(22400))
