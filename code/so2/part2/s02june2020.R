...
my.at <- seq(-1, +1, 0.1)
newcol<-rasterTheme(region=jet.colors(256,alpha = 1))
par(mfrow=c(1,3))
mapTheme <- rasterTheme(region=jet.colors(256,alpha = 1))
plt <- levelplot(subtract, margin=FALSE,cuts=100,at=my.at,par.settings=mapTheme,main="SO2 Index - Diffrence June(2020-2019)",shrink=c(1,1), interpolate=T, cex=2)
