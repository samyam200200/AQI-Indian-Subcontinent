...
plt <- levelplot(subtract, margin=FALSE,cuts=100,at=my.at,par.settings=mapTheme,main="SO2 Index - Diffrence August(2020-2019)",shrink=c(1,1), interpolate=T, cex=2)
